...
class UI{
      displayProducts(products){
                ...
                productDiv.innerHTML=`<div class = "product-card"> <img src="${product.image}" alt="product">
...
addCartItem(cartItem){
    ...
    cartItemUi.innerHtml=`<div class="cart-product">
      ...
      <div class="cart-product-remove data="${cartItem.id}" href="#" style="color:red;> remove </a> </div>
      </div>
